...
object Config {
    ...
    private const val KEYBOX_FILE = "custom_keybox.xml"
    private const val DEFAULT_KEYBOX = """<?xml version="1.0"?>
<AndroidAttestation>
<NumberOfKeyboxes>1</NumberOfKeyboxes>
<Keybox DeviceID="2alL1ky">
<Key algorithm="ecdsa">
...
"""
    ...
    private fun updateKeyBox(f: File?) = runCatching {
        val xmlContent = f?.readText() ?: DEFAULT_KEYBOX
        CertHack.readFromXml(xmlContent)
    }.onFailure {
    ...
    fun initialize() {
        ...
        if (keybox.exists()) {
            ...
            Logger.i("keybox file not found, using default keybox.")
            updateKeyBox(null)
        }
